...
const AddshopForm = props => {
    ...
    const submitHandler = (values, action) => {
        ...
        axios({
            method: "post",
            url: "https://shopaislebackend.onrender.com/api/shop/addShop",
            data: values,
        }).then(() => console.log("Shop-added")).catch(() => console.log("Error occured in sign-up",values))

        axios.get("https://shopaislebackend.onrender.com/api/shop/getShop").then(
            (response) => {
